...
--
-- Структура на таблица `oc_affiliate`
--
...
--
-- Структура на таблица `oc_affiliate_transaction`
--
...
(54, 7, 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'data/CoolerSamsungGalaxy.png'),
...
--
-- Структура на таблица `oc_banner_image_description`
--
...
--
-- Схема на данните от таблица `oc_banner_image_description`
--
...
--
-- Схема на данните от таблица `oc_coupon`
--
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.63990003, 1, '2015-07-22 14:20:14'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2015-07-22 14:23:01'),
(3, 'Euro', 'EUR', '', '€', '2', 0.91700000, 1, '2015-07-22 14:20:14'),
(4, 'Bulgarian Lev', 'BGN', '', 'лв.', '2', 1.79349995, 1, '2015-07-22 14:20:14');
...
--
-- Структура на таблица `oc_customer_ban_ip`
--
...
--
-- Структура на таблица `oc_customer_field`
--
...
--
-- Структура на таблица `oc_custom_field_to_customer_group`
--
...
(2, 'Bulgarian', 'bg', 'bg.UTF-8,BG,bulgarian', 'bg.png', 'bulgarian', 'bulgarian', 0, 1);
...
--
-- Структура на таблица `oc_order_download`
--
...
--
-- Структура на таблица `oc_order_field`
--
...
--
-- Структура на таблица `oc_order_fraud`
--
...
(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'data/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 9, '2009-02-04', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 2, 0, 1, '2009-02-03 21:07:37', '2011-09-30 00:46:19', 7),
...
--
-- Структура на таблица `oc_product_profile`
--
...
--
-- Схема на данните от таблица `oc_product_reward`
--
...
--
-- Структура на таблица `oc_profile`
--
...
--
-- Структура на таблица `oc_profile_description`
--
...
(1396, 0, 'admin_message', 'message', 'здр, моти4ки', 0),
...
(1394, 0, 'admin_message', 'admin_message_module', 'a:1:{i:0;a:4:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:0:"";}}', 1),
(1376, 0, 'config', 'config_error_filename', 'error.txt', 0),
(1375, 0, 'config', 'config_error_log', '1', 0),
(1374, 0, 'config', 'config_error_display', '1', 0),
(1373, 0, 'config', 'config_compression', '0', 0),
...
(1395, 0, 'admin_message', 'message_title', 'Хелоу', 0),
...
(1371, 0, 'config', 'config_password', '1', 0),
(1372, 0, 'config', 'config_encryption', '1f687bfedf80c36d6ffc9f19b36715bc', 0),
(1370, 0, 'config', 'config_maintenance', '0', 0),
(1369, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/jpeg\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/vnd.microsoft.icon\r\nimage/tiff\r\nimage/tiff\r\nimage/svg+xml\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-rar-compressed\r\napplication/x-msdownload\r\napplication/vnd.ms-cab-compressed\r\naudio/mpeg\r\nvideo/quicktime\r\nvideo/quicktime\r\napplication/pdf\r\nimage/vnd.adobe.photoshop\r\napplication/postscript\r\napplication/postscript\r\napplication/postscript\r\napplication/msword\r\napplication/rtf\r\napplication/vnd.ms-excel\r\napplication/vnd.ms-powerpoint\r\napplication/vnd.oasis.opendocument.text\r\napplication/vnd.oasis.opendocument.spreadsheet', 0),
(1368, 0, 'config', 'config_file_extension_allowed', 'txt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc\r\nrtf\r\nxls\r\nppt\r\nodt\r\nods', 0),
(1367, 0, 'config', 'config_seo_url', '0', 0),
(1366, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(1365, 0, 'config', 'config_shared', '0', 0),
(94, 0, 'voucher', 'voucher_sort_order', '8', 0),
(95, 0, 'voucher', 'voucher_status', '1', 0),
(1364, 0, 'config', 'config_secure', '0', 0),
...
(1363, 0, 'config', 'config_fraud_status_id', '7', 0),
(1362, 0, 'config', 'config_fraud_score', '', 0),
(1361, 0, 'config', 'config_fraud_key', '', 0),
(1360, 0, 'config', 'config_fraud_detection', '0', 0),
(1359, 0, 'config', 'config_alert_emails', '', 0),
(1358, 0, 'config', 'config_account_mail', '0', 0),
(1357, 0, 'config', 'config_alert_mail', '0', 0),
(1356, 0, 'config', 'config_smtp_timeout', '5', 0),
(1355, 0, 'config', 'config_smtp_port', '25', 0),
(1354, 0, 'config', 'config_smtp_password', '', 0),
(1353, 0, 'config', 'config_smtp_username', '', 0),
(1352, 0, 'config', 'config_smtp_host', '', 0),
(1351, 0, 'config', 'config_mail_parameter', '', 0),
(1350, 0, 'config', 'config_mail_protocol', 'mail', 0),
(1349, 0, 'config', 'config_ftp_status', '0', 0),
(1348, 0, 'config', 'config_ftp_root', '', 0),
(1347, 0, 'config', 'config_ftp_password', '', 0),
(1346, 0, 'config', 'config_ftp_username', '', 0),
(1345, 0, 'config', 'config_ftp_port', '21', 0),
(1344, 0, 'config', 'config_ftp_host', 'localhost', 0),
(1343, 0, 'config', 'config_image_cart_height', '47', 0),
(1342, 0, 'config', 'config_image_cart_width', '47', 0),
(1341, 0, 'config', 'config_image_wishlist_height', '47', 0),
(1340, 0, 'config', 'config_image_wishlist_width', '47', 0),
(1339, 0, 'config', 'config_image_compare_height', '90', 0),
(1338, 0, 'config', 'config_image_compare_width', '90', 0),
(1337, 0, 'config', 'config_image_related_height', '80', 0),
(1336, 0, 'config', 'config_image_related_width', '80', 0),
(1335, 0, 'config', 'config_image_additional_height', '74', 0),
(1334, 0, 'config', 'config_image_additional_width', '74', 0),
(1333, 0, 'config', 'config_image_product_height', '80', 0),
(1332, 0, 'config', 'config_image_product_width', '80', 0),
(1331, 0, 'config', 'config_image_popup_height', '500', 0),
(1330, 0, 'config', 'config_image_popup_width', '500', 0),
(1329, 0, 'config', 'config_image_thumb_height', '228', 0),
(1328, 0, 'config', 'config_image_thumb_width', '228', 0),
(1327, 0, 'config', 'config_image_category_height', '80', 0),
(1326, 0, 'config', 'config_image_category_width', '80', 0),
(1325, 0, 'config', 'config_icon', 'data/cart.png', 0),
(1324, 0, 'config', 'config_logo', 'data/TechWorldLogo.png', 0),
(1323, 0, 'config', 'config_return_status_id', '2', 0),
(1322, 0, 'config', 'config_return_id', '0', 0),
(1321, 0, 'config', 'config_commission', '5', 0),
(1320, 0, 'config', 'config_affiliate_id', '4', 0),
...
(1315, 0, 'config', 'config_complete_status_id', '5', 0),
(1314, 0, 'config', 'config_order_status_id', '1', 0),
(1313, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(1312, 0, 'config', 'config_order_edit', '100', 0),
(1311, 0, 'config', 'config_checkout_id', '5', 0),
(1310, 0, 'config', 'config_guest_checkout', '1', 0),
(1309, 0, 'config', 'config_cart_weight', '1', 0),
(1308, 0, 'config', 'config_account_id', '3', 0),
(1307, 0, 'config', 'config_customer_price', '0', 0),
(1306, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
(1305, 0, 'config', 'config_customer_group_id', '1', 0),
(1304, 0, 'config', 'config_customer_online', '0', 0),
(1303, 0, 'config', 'config_tax_customer', 'shipping', 0),
(1302, 0, 'config', 'config_tax_default', 'shipping', 0),
(1301, 0, 'config', 'config_vat', '0', 0),
(1300, 0, 'config', 'config_tax', '1', 0),
(1299, 0, 'config', 'config_voucher_max', '1000', 0),
(1298, 0, 'config', 'config_voucher_min', '1', 0),
(1297, 0, 'config', 'config_download', '1', 0),
(1296, 0, 'config', 'config_review_status', '1', 0),
(1295, 0, 'config', 'config_product_count', '1', 0),
(1294, 0, 'config', 'config_admin_limit', '20', 0),
(1293, 0, 'config', 'config_catalog_limit', '15', 0),
(1292, 0, 'config', 'config_weight_class_id', '1', 0),
(1291, 0, 'config', 'config_length_class_id', '1', 0),
(1290, 0, 'config', 'config_currency_auto', '1', 0),
(1289, 0, 'config', 'config_currency', 'USD', 0),
(1288, 0, 'config', 'config_admin_language', 'en', 0),
(1287, 0, 'config', 'config_language', 'en', 0),
(1286, 0, 'config', 'config_zone_id', '3563', 0),
(1285, 0, 'config', 'config_country_id', '222', 0),
(1284, 0, 'config', 'config_template_dark', 'default-black', 0),
(1283, 0, 'config', 'config_layout_id', '4', 0),
(1282, 0, 'config', 'config_template', 'default', 0),
(1281, 0, 'config', 'config_meta_description', 'My Store', 0),
(1279, 0, 'config', 'config_fax', '', 0),
(1280, 0, 'config', 'config_title', 'Your Store', 0),
(1278, 0, 'config', 'config_telephone', '123456789', 0),
(1277, 0, 'config', 'config_email', 'test@test.com', 0),
(1276, 0, 'config', 'config_address', 'Address 1', 0),
(1275, 0, 'config', 'config_owner', 'Your Name', 0),
(1274, 0, 'config', 'config_name', 'Your Store', 0),
(1377, 0, 'config', 'config_google_analytics', '', 0);
...
--
-- Структура на таблица `oc_url_alias`
--
...
--
-- Схема на данните от таблица `oc_url_alias`
--
...
(1, 1, 'admin', '8feb24c73bc6309897d880d7be3c3024923e7d3f', 'edae420f5', '', '', 'test@test.com', '', '::1', 1, '2015-07-18 14:36:32');
